...
class CourseLecturePage extends StatelessWidget {
        ...
        children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          section.title,
                          style: TextStyle(fontWeight: FontWeight.bold, fontSize:size.contentFontSize,
                          color: themeController.isDarkMode.value ? darkgray : black),
                        ),
                        Text(
                          section.duration,
                          style: TextStyle(color: newprimaryColor,fontSize:size.subtitleFontsize),
                        ),
                      ],
                    ),
                    SizedBox(height: 8),
          ...
          Align(
            ...
            child: Container(
              ...
              child: Center(child: Text("Start Course Again",style: TextStyle(fontSize:size.subtitleFontsize, color: white ),)),
            ),
          )
